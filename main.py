...
snake_object = snake.Snake(SNAKE_START[0], SNAKE_START[1], GRID_SQUARE_SIZE, snake.Direction.DOWN, WINDOW_WIDTH - GRID_SQUARE_SIZE, WINDOW_HEIGHT - GRID_SQUARE_SIZE)
